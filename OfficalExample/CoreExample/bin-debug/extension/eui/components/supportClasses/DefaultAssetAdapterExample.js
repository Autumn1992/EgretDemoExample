 ...
 */
var DefaultAssetAdapterExample = (function (_super) {
    __extends(DefaultAssetAdapterExample, _super);
    function DefaultAssetAdapterExample() {
        var _this = _super.call(this) || this;
        _this.once(egret.Event.ADDED_TO_STAGE, _this.onAddedToStage, _this);
        return _this;
    }
    DefaultAssetAdapterExample.prototype.onAddedToStage = function (e) {
    ...
    DefaultAssetAdapterExample.prototype.assetLoaded = function (content, source) {
...
__reflect(DefaultAssetAdapterExample.prototype, "DefaultAssetAdapterExample");
