...
*/
var TimerExample = (function (_super) {
    __extends(TimerExample, _super);
    ...
    TimerExample.prototype.timerFunc = function (event) {
    ...
    TimerExample.prototype.timerComFunc = function (event) {
        egret.log("timerComFunc count" + event.target.currentCount);
        ////timerFunc count5
    };
    return TimerExample;
}(egret.DisplayObjectContainer));
__reflect(TimerExample.prototype, "TimerExample");
