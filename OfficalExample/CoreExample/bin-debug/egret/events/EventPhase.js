 ...
 * 以下示例演示了事件的各个阶段。
 */
var EventPhaseExample = (function (_super) {
    __extends(EventPhaseExample, _super);
    ...
    return EventPhaseExample;
}(egret.DisplayObjectContainer));
__reflect(EventPhaseExample.prototype, "EventPhaseExample");
